...
public class PlusImageView extends ImageView {
    ...
    public PlusImageView load(String url, int placeholderDrawableResId, int errorDrawableResId) {
        ...
        Picasso.with(APP.appContext).load(url).placeholder(placeholderDrawableResId).error(errorDrawableResId).into(this);
        return this;
    }

    public PlusImageView load(File file, int placeholderDrawableResId, int errorDrawableResId) {
        Picasso.with(APP.appContext).load(file).placeholder(placeholderDrawableResId).error(errorDrawableResId).into(this);
        return this;
    }

    public PlusImageView load(int resId, int placeholderDrawableResId, int errorDrawableResId) {
        Picasso.with(APP.appContext).load(resId).placeholder(placeholderDrawableResId).error(errorDrawableResId).into(this);
        return this;
    }

    public PlusImageView load(Uri uri, int placeholderDrawableResId, int errorDrawableResId) {
        Picasso.with(APP.appContext).load(uri).placeholder(placeholderDrawableResId).error(errorDrawableResId).into(this);
        return this;
    }
